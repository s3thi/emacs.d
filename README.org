...
- Is it possible to make Markdown mode behave like org-mode in terms
  of indenting text nested under headings?
...
Increase =fill-column= to a more reasonable value.
